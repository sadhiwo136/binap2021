@extends('layouts.appWarga')

@section('title')
    Detail Laporan Saya | PSU App Prototype
@endsection
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/update_laporan/{{ $laporan->id_laporan }}" method="POST">
                    {{ csrf_field() }}
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="">
                    ...
                    <div class="card-body" style="text-align:center;">
                        <button type="submit" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">Update Laporan</button>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body" style="text-align: center;">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/updatew_foto1/{{ $laporan->id_laporan }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/updatew_foto2/{{ $laporan->id_laporan }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                ...
                <div class="card-body" style="text-align:center;">
                    <form action="/del_laporanwarga/{{ $laporan->id_laporan }}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
